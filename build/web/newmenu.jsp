  ...
  <div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom" id="menubar">
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
          <li><a href="landingPage.jsp" class="nav-link px-2 text-black" style="font-family: 'Playfair Display'">HOME</a></li>
          ...
          <li><a href=checkStatus?userId=${User.getUserId()} class="nav-link px-2 text-black" style="font-family: 'Playfair Display'; padding-left: 3rem">STATUS</a></li>
