  ...
  <div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom" id="menubar">
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
          <li><a onclick="loadFNOLDetails()" class="nav-link px-2 text-black" style="font-family: 'Playfair Display'">NOTICES</a></li>
          <li><a onclick="loadPolicyDetails()"  class="nav-link px-2 text-black" style="font-family: 'Playfair Display'; padding-left: 3rem">POLICY</a></li>
          <li><a onclick="loadDriverInfo()" class="nav-link px-2 text-black" style="font-family: 'Playfair Display'; padding-left: 3rem">DMV</a></li>
